...
**Language:** ask in the user's language; write `context.md` in English (SKILL.md Critical Rule 6). The user's answer is recorded as an English decision, not transcribed.
